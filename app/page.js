  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-[#FF9A8B] to-[#FF6B6B]">
      ...
      >
        ...
        >
        اللعبة بسيطة وممتعة! 🎉 كل اللاعبين ياخذون نفس الموضوع، ومهمتهم إنهم يخمنون نفس الكلمة اللي تتعلق بالموضوع (مثلاً: لو كان الموضوع رياضة، اللاعبين يخمنون "كرة القدم"). كل ما زادت التخمينات المشتركة بين اللاعبين، زادت النقاط اللي يحصلونها. الفكرة إنكم تفكرون زي بعض وتدخلون جو! 😄        </motion.p>
        <motion.div 
          variants={itemVariants}
          className="space-y-6"
        >
